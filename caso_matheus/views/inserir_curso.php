...
<form method="post" action="processa_curso.php"> <!-- Vai enviar o formulario pra pag processa_curso -->
	<br>
...
<?php } else { ?>
	...
	<?php while($linha = mysqli_fetch_array($consulta_cursos)) {  ?>
		<?php if($linha['id_curso'] == $_GET['editar']) { ?>
			<h1>Editar curso</h1>
			<form method="post" action="edita_curso.php"> <!-- Vai enviar o formulario pra pag processa_curso -->
